import{a as g}from"./vendor-N5iQpiFS.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))t(a);new MutationObserver(a=>{for(const r of a)if(r.type==="childList")for(const c of r.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&t(c)}).observe(document,{childList:!0,subtree:!0});function s(a){const r={};return a.integrity&&(r.integrity=a.integrity),a.referrerPolicy&&(r.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?r.credentials="include":a.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function t(a){if(a.ep)return;a.ep=!0;const r=s(a);fetch(a.href,r)}})();const P="https://your-energy.b.goit.study/api",S={mobile:9,tablet:12,desktop:12};g.defaults.baseURL=P;const q=(i,e,s)=>{const t={filter:i,page:e,limit:s};return g.get("/filters",{params:t})},C=i=>g.get(`/exercises/${i}`),T=i=>g.get("/exercises",{params:i}),d="/your-energy/assets/sprite-gtohewle.svg";class v{constructor(e,s,t,a,r,c,h,n,o,l,u){this.id=e,this.bodyPart=s,this.equipment=t,this.gifUrl=a,this.name=r,this.target=c,this.description=h,this.rating=n,this.burnedCalories=o,this.time=l,this.popularity=u}setRatingVisible(e){this.ratingVisible=e}setTrashVisible(e){this.trashVisible=e}static async fetchById(e){const t=(await C(e)).data;return new v(t._id,t.bodyPart,t.equipment,t.gifUrl,t.name,t.target,t.description,t.rating,t.burnedCalories,t.time,t.popularity)}render(e=!0,s=!1){const t=document.createElement("div");return t.className="exercise-card",t.innerHTML=`  
    ...
    `,e}formatRating(){return this.rating.toFixed(1)}getStarRatingHTML(){let e="";const s='<svg width="18" height="18"><use href="${sprite}#star-active"></use></svg>',t='<svg width="18" height="18"><use href="${sprite}#star-inactive"></use></svg>';return e+=s.repeat(this.rating.toFixed(0)),e+=t.repeat(5-this.rating.toFixed(0)),e}}const b=document.querySelector(".modal-page");b&&v.fetchById("64f389465ae26083f39b17df").then(i=>{b.append(i.renderCard())});class f{constructor(){this.exercises=[],this.page=0,this.perPage=10,this.totalPages=0}addExercise(e){this.exercises.push(e)}static async fetchWithFilters(e){const t=(await T(e.toParams())).data,a=new f;return a.page=t.page,a.perPage=t.perPage,a.totalPages=t.totalPages,t.results.forEach(r=>{const c=new v(r._id,r.bodyPart,r.equipment,r.gifUrl,r.name,r.target,r.description,r.rating,r.burnedCalories,r.time,r.popularity);a.addExercise(c)}),a}render(e=!0,s=!1){const t=document.createElement("div");return t.className="exercise-list",this.exercises.forEach(a=>{t.appendChild(a.render(e,s))}),t}}const m=Object.freeze({MUSCLES:"muscles",BODY_PART:"bodypart",EQUIPMENT:"equipment"});class j{constructor({bodypart:e,muscles:s,equipment:t,keyword:a,page:r=1,limit:c=10}={}){this.bodypart=e,this.muscles=s,this.equipment=t,this.keyword=a,this.page=r,this.limit=c}addFilter(e,s){switch(e){case m.MUSCLES:this.muscles=s;break;case m.BODY_PART:this.bodypart=s;break;case m.EQUIPMENT:this.equipment=s;break}}toParams(){const e={};return this.bodypart&&(e.bodypart=this.bodypart),this.muscles&&(e.muscles=this.muscles),this.equipment&&(e.equipment=this.equipment),this.keyword&&(e.keyword=this.keyword),e.page=this.page,e.limit=this.limit,e}}const y=document.querySelector(".exercise-container");let x=new f;const k=async i=>{try{x=await f.fetchWithFilters(i);const e=x.render(!0,!1);y.innerHTML="",y.appendChild(e)}catch(e){console.error(e)}};function A(i,e){const s=new j({page:1,limit:10});s.addFilter(i,e),k(s),y.classList.remove("hidden")}const L=()=>{const i=window.innerWidth;return i<768?"mobile":i<1440?"tablet":"desktop"},M=()=>S[L()],p=document.querySelector(".category-list"),$=document.querySelector(".category-container"),I=i=>i.reduce((e,s)=>e+`<li class="category-card" data-name="${s.name}" data-filter="${s.filter}">
      <img class="gallery-image"
          ...
          </li>`,""),B=async(i,e)=>{try{const s=await q(i,e,M()),{page:t,perPage:a,totalPages:r,results:c}=s.data;return c.length===0?(console.log("There are no categories for the specified filter"),{page:t,perPage:a,totalPages:r}):(p.innerHTML=I(c),p.addEventListener("click",w),$.classList.add("active"),{page:t,perPage:a,totalPages:r})}catch(s){console.log(s)}},O=()=>{p.innerHTML="",p.removeEventListener("click",w),$.classList.remove("active")},w=i=>{if(i.preventDefault(),console.log(L()),i.target===i.currentTarget)return;const e=i.target.closest("li"),s=e.getAttribute("data-filter"),t=e.getAttribute("data-name");O(),A(R(s),t),console.log(`Execute function for rendering exercises (${s}; ${t})`)},R=i=>{const e=i.toLowerCase();return Object.values(m).find(s=>s===e)},E=document.querySelector(".fav-list-card"),N=[1,2,3,4,5,6,7,8],F=N.map(i=>`<li class="list-card-item" data-id="${i}">
