import{a as v,i as d}from"./vendor-Cbhu4xvy.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))t(r);new MutationObserver(r=>{for(const a of r)if(a.type==="childList")for(const o of a.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&t(o)}).observe(document,{childList:!0,subtree:!0});function i(r){const a={};return r.integrity&&(a.integrity=r.integrity),r.referrerPolicy&&(a.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?a.credentials="include":r.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function t(r){if(r.ep)return;r.ep=!0;const a=i(r);fetch(r.href,a)}})();const B="https://your-energy.b.goit.study/api",U={mobile:9,tablet:12,desktop:12};v.defaults.baseURL=B;const _=(s,e,i)=>{const t={filter:s,page:e,limit:i};return v.get("/filters",{params:t})},H=s=>v.get(`/exercises/${s}`),G=s=>v.get("/exercises",{params:s}),u="/your-energy/assets/sprite-gtohewle.svg";class f{constructor(e,i,t,r,a,o,g,n,c,l,m){this.id=e,this.bodyPart=i,this.equipment=t,this.gifUrl=r,this.name=a,this.target=o,this.description=g,this.rating=n,this.burnedCalories=c,this.time=l,this.popularity=m}setRatingVisible(e){this.ratingVisible=e}setTrashVisible(e){this.trashVisible=e}static async fetchById(e){const t=(await H(e)).data;return new f(t._id,t.bodyPart,t.equipment,t.gifUrl,t.name,t.target,t.description,t.rating,t.burnedCalories,t.time,t.popularity)}render(e=!0,i=!1){const t=document.createElement("div");return t.className="exercise-card",t.innerHTML=`  
    ...
    `,e}formatRating(){return this.rating.toFixed(1)}getStarRatingHTML(){let e="";const i='<svg width="18" height="18"><use href="${sprite}#star-active"></use></svg>',t='<svg width="18" height="18"><use href="${sprite}#star-inactive"></use></svg>';return e+=i.repeat(this.rating.toFixed(0)),e+=t.repeat(5-this.rating.toFixed(0)),e}}const S=document.querySelector(".modal-page");S&&f.fetchById("64f389465ae26083f39b17df").then(s=>{S.append(s.renderCard())});const P=()=>{const s=window.innerWidth;return s<768?"mobile":s<1440?"tablet":"desktop"},z=()=>U[P()];class y{constructor(){this.exercises=[],this.page=0,this.perPage=10,this.totalPages=0}addExercise(e){this.exercises.push(e)}static async fetchWithFilters(e){const t=(await G(e.toParams())).data,r=new y;return r.page=t.page,r.perPage=t.perPage,r.totalPages=t.totalPages,t.results.forEach(a=>{const o=new f(a._id,a.bodyPart,a.equipment,a.gifUrl,a.name,a.target,a.description,a.rating,a.burnedCalories,a.time,a.popularity);r.addExercise(o)}),r}render(e=!0,i=!1){const t=document.createElement("div");return t.className="exercise-list",this.exercises.forEach(r=>{t.appendChild(r.render(e,i))}),t}}const h=Object.freeze({MUSCLES:"muscles",BODY_PART:"bodypart",EQUIPMENT:"equipment"});class J{constructor({bodypart:e,muscles:i,equipment:t,keyword:r,page:a=1,limit:o=10}={}){this.bodypart=e,this.muscles=i,this.equipment=t,this.keyword=r,this.page=a,this.limit=o}addFilter(e,i){switch(e){case h.MUSCLES:this.muscles=i;break;case h.BODY_PART:this.bodypart=i;break;case h.EQUIPMENT:this.equipment=i;break}}addKeyword(e){this.keyword=e}toParams(){const e={};return this.bodypart&&(e.bodypart=this.bodypart),this.muscles&&(e.muscles=this.muscles),this.equipment&&(e.equipment=this.equipment),this.keyword&&(e.keyword=this.keyword),e.page=this.page,e.limit=this.limit,e}}const C=document.querySelector(".loader"),T=()=>{C.classList.remove("hidden")},k=()=>{C.classList.add("hidden")},L=document.querySelector(".exercise-container");let x=new y;const K=async s=>{try{T(),x=await y.fetchWithFilters(s);const e=x.render(!0,!1);L.innerHTML="",L.appendChild(e)}catch(e){console.error(e)}finally{k()}};function j(s,e,i=null){const t=new J({page:1,limit:10});i&&t.addKeyword(i),t.addFilter(s,e),K(t),L.classList.remove("hidden")}const p=document.querySelector(".category-list"),A=document.querySelector(".category-container"),W=s=>s.reduce((e,i)=>e+`<li class="category-card" data-name="${i.name}" data-filter="${i.filter}">
