import{a as p,i as g}from"./vendor-Cbhu4xvy.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))a(r);new MutationObserver(r=>{for(const i of r)if(i.type==="childList")for(const n of i.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&a(n)}).observe(document,{childList:!0,subtree:!0});function s(r){const i={};return r.integrity&&(i.integrity=r.integrity),r.referrerPolicy&&(i.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?i.credentials="include":r.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function a(r){if(r.ep)return;r.ep=!0;const i=s(r);fetch(r.href,i)}})();const V="https://your-energy.b.goit.study/api",ie={mobile:9,tablet:12,desktop:12},ne={mobile:8,tablet:10,desktop:10};p.defaults.baseURL=V;const oe=(t,e,s)=>{const a={filter:t,page:e,limit:s};return p.get("/filters",{params:a})},ce=t=>p.get(`/exercises/${t}`),le=t=>p.get("/exercises",{params:t}),de=(t,e,s,a)=>{const r={rate:e,email:s,review:a};return p.patch(`/exercises/${t}/rating`,r)},m="/your-energy/assets/sprite-D8xu5p1j.svg",ue="/your-energy/assets/no-image-B2yyVwMF.jpg";function me(t,e){const s="#EEA10C",a="#F4F4F4";let i="";for(let n=0;n<5;n++){const d=`starGradient${n}`,o=n+1<=t?100:n<t?t%1*100:0,l=[{offset:"0%",color:s,opacity:"1"},{offset:`${o}%`,color:s,opacity:"1"},{offset:`${o+1}%`,color:a,opacity:"0.20"}],u=`
          ...
          `,c=`url(#${d})`;i+=`<svg xmlns="http://www.w3.org/2000/svg" width="14" height="13" viewBox="0 0 14 13" fill="none">${u}<path d="M6.04894 0.927052C6.3483 0.0057416 7.6517 0.00574088 7.95106 0.927052L8.79611 3.52786C8.92999 3.93989 9.31394 4.21885 9.74717 4.21885H12.4818C13.4505 4.21885 13.8533 5.45846 13.0696 6.02786L10.8572 7.63525C10.5067 7.8899 10.3601 8.34127 10.494 8.75329L11.339 11.3541C11.6384 12.2754 10.5839 13.0415 9.80017 12.4721L7.58779 10.8647C7.2373 10.6101 6.7627 10.6101 6.41222 10.8647L4.19983 12.4721C3.41612 13.0415 2.36164 12.2754 2.66099 11.3541L3.50604 8.75329C3.63992 8.34127 3.49326 7.8899 3.14277 7.63525L0.930391 6.02787C0.146677 5.45846 0.549452 4.21885 1.51818 4.21885H4.25283C4.68606 4.21885 5.07001 3.93989 5.20389 3.52786L6.04894 0.927052Z" fill="${c}" fill-opacity="1"/></svg>`}return i}const z=document.querySelector(".loader"),T=()=>{z.classList.remove("hidden")},O=()=>{z.classList.add("hidden")};class w{constructor(e,s,a,r,i,n,d,o,l,u,c){this.id=e,this.bodyPart=s,this.equipment=a,this.gifUrl=r,this.name=i,this.target=n,this.description=d,this.rating=o,this.burnedCalories=l,this.time=u,this.popularity=c}setRatingVisible(e){this.ratingVisible=e}setTrashVisible(e){this.trashVisible=e}static async fetchById(e){try{T();const a=(await ce(e)).data;return new w(a._id,a.bodyPart,a.equipment,a.gifUrl,a.name,a.target,a.description,a.rating,a.burnedCalories,a.time,a.popularity)}catch(s){throw console.error("Error fetching exercise:",s),s}finally{O()}}render(e=!0,s=!1){const a=document.createElement("div");return a.className="exercise-card",a.innerHTML=`  
  ...
  `}document.addEventListener("DOMContentLoaded",be);const F={0:m+"#two-angle-left",1:m+"#one-angle-left",6:m+"#one-angle-right",7:m+"#two-angle-right"},Le=(t,e)=>{const s=[];if(t<4)for(let a=0;a<4;a++)s.push(1+a);if(e-t<3&&s.length===0)for(let a=0;a<4;a++)s.unshift(e-a);if(s.length===0)for(let a=-1;a<3;a++)s.push(t+a);s[3]<e&&(s[3]=0),s[3]===e&&s[0]!=1&&(s[0]=0);for(let a=0;a<4;a++)s[a]>e&&(s[a]=-1);return s.unshift(t>1?t-1:-1),s.unshift(t>1?1:-1),s.push(t<e?t+1:-1),s.push(t<e?e:-1),s},Se=(t,e)=>{const s=Le(t,e),a=new Set([0,1]),r=new Set([6,7]),i=a.union(r);return s.map((n,d)=>[d,n,i.has(d)?"":n===0?"...":n>0?n:"",n===t||a.has(d)&&t!=1||r.has(d)&&t!=e,i.has(d)||n===t])},Ee=t=>F.hasOwnProperty(t)?`<svg width="20" height="20"><use href="${F[t]}"></use></svg>`:"",we=(t,e,s,a,r)=>`<li class="pagination-item${a?" accent":""}${r?" outline":""}${e===-1&&!r?" hidden-btn":""}" data-page="${e}">${s}${Ee(t)}</li>`,xe=(t,e)=>Se(t,e).reduce((a,r)=>a+we(...r),""),$e=(t,e)=>`<ul class="pagination">${xe(t,e)}</ul>`,qe=(t,...e)=>s=>{s.preventDefault();const a=s.currentTarget;if(s.target===s.currentTarget)return;const r=Number(s.target.closest("li").getAttribute("data-page"));if(r==-1)return;a.remove();let i=Array.from(...e);i.splice(-1,1,r),t.apply(null,i)},K=(t,e,s,a,...r)=>{const i=document.querySelector(t);i.innerHTML=$e(e,s),i.firstChild.addEventListener("click",qe(a,r))},W=t=>{const e=document.querySelector(t);e.firstChild&&e.firstChild.remove()},Y=()=>{const t=window.innerWidth;return t<768?"mobile":t<1440?"tablet":"desktop"},Ie=()=>ie[Y()],Ce=()=>ne[Y()];class x{constructor(){this.exercises=[],this.page=0,this.perPage=10,this.totalPages=0}addExercise(e){this.exercises.push(e)}static async fetchWithFilters(e){const a=(await le(e.toParams())).data,r=new x;return r.page=a.page,r.perPage=a.perPage,r.totalPages=a.totalPages,a.results.forEach(i=>{const n=new w(i._id,i.bodyPart,i.equipment,i.gifUrl,i.name,i.target,i.description,i.rating,i.burnedCalories,i.time,i.popularity);r.addExercise(n)}),r}render(e=!0,s=!1){const a=document.createElement("div");return a.className="exercise-list",this.exercises.forEach(r=>{a.appendChild(r.render(e,s))}),a}}const b=Object.freeze({MUSCLES:"muscles",BODY_PART:"bodypart",EQUIPMENT:"equipment"});class _e{constructor({bodypart:e,muscles:s,equipment:a,keyword:r,page:i=1,limit:n=10}={}){this.bodypart=e,this.muscles=s,this.equipment=a,this.keyword=r,this.page=i,this.limit=n}addFilter(e,s){switch(e){case b.MUSCLES:this.muscles=s;break;case b.BODY_PART:this.bodypart=s;break;case b.EQUIPMENT:this.equipment=s;break}}addKeyword(e){this.keyword=e}toParams(){const e={};return this.bodypart&&(e.bodypart=this.bodypart),this.muscles&&(e.muscles=this.muscles),this.equipment&&(e.equipment=this.equipment),this.keyword&&(e.keyword=this.keyword),e.page=this.page,e.limit=this.limit,e}}const f=document.querySelector(".exercise-container");let v=new x;const Q=async(t,e=1)=>{try{T(),t.page=e,v=await x.fetchWithFilters(t);const s=v.render(!0,!1);f.innerHTML="",f.appendChild(s),K(".pagination-container",v.page,v.totalPages,Q,t,v.page)}catch(s){console.error(s)}finally{O()}};function Z(t,e,s=null){const a=new _e({page:1,limit:Ce()});s&&a.addKeyword(s),a.addFilter(t,e),Q(a),f.classList.add("active")}function ke(){f.innerHTML="",f.classList.contains("active")&&f.classList.remove("active"),W(".pagination-container")}const L=document.querySelector(".category-list"),X=document.querySelector(".category-container"),Pe=t=>t.reduce((e,s)=>e+`<li class="category-card" data-name="${s.name}" data-filter="${s.filter}">
      <img class="gallery-image"
          ...
          </li>`,""),M=async(t,e)=>{try{T();const s=await oe(t,e,Ie()),{page:a,totalPages:r,results:i}=s.data;i.length===0&&(L.innerHTML=""),L.innerHTML=Pe(i),L.addEventListener("click",ee),X.classList.add("active"),K(".pagination-container",e,r,M,t,a),ke()}catch(s){console.log(s)}finally{O()}},Te=()=>{L.innerHTML="",W(".pagination-container"),L.removeEventListener("click",ee),X.classList.remove("active")},ee=t=>{if(t.preventDefault(),t.target===t.currentTarget)return;const e=t.target.closest("li"),s=e.getAttribute("data-filter"),a=e.getAttribute("data-name");Te(),Z(Oe(s),a),je(s,a)},Oe=t=>{const e=t.toLowerCase();return Object.values(b).find(s=>s===e)};M("Muscles",1);const D=document.querySelectorAll(".filter-tab-button"),te=document.querySelector(".filter-form-container"),H=document.querySelector(".search-button"),_=document.querySelector(".cansel-search-button"),E=document.querySelector(".search-string"),se=document.querySelector(".additional-title-filter"),ae=document.querySelector(".slash-in-filter");var $="",q="",k="";const Me={"button-muscles":"Muscles","button-bodypart":"Body parts","button-equipment":"Equipment"};E&&E.addEventListener("input",function(){_.style.display=this.value.length>0?"block":"none"});_&&_.addEventListener("click",function(){E.value="",this.style.display="none"});D.forEach(t=>{t.addEventListener("click",e=>{if(e.preventDefault(),Be(),e.target&&e.target.matches("button.filter-tab-button")){D.forEach(r=>{r.classList.remove("active")}),t.classList.add("active");const s=e.target.id,a=Me[s];M(a,1)}})});H&&H.addEventListener("click",t=>{t.preventDefault(),k=E.value,Z(Ae($),q,k)});function Ae(t){var e=t.toLowerCase();return e==="body parts"&&(e="bodypart"),Object.values(b).find(s=>s===e)}function Ne(t){ae.style.display="inline",se.textContent=t}function Be(){ae.style.display="none",te.style.display="none",se.textContent="",Fe()}function je(t,e){Re(t,e),Ne(e),te.style.display="block",console.log(`filterName: ${$}  categoryName: ${q}`)}function Re(t,e){$=t,q=e}function Fe(){$="",q="",E.value="",k=""}const De=async t=>await p.get(`https://your-energy.b.goit.study/api/exercises/${t}`),He=t=>t.map(e=>`<li class="list-card-item" data-id="${e._id}">
