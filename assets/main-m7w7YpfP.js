import{a as y,i as m}from"./vendor-Cbhu4xvy.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))s(i);new MutationObserver(i=>{for(const r of i)if(r.type==="childList")for(const n of r.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&s(n)}).observe(document,{childList:!0,subtree:!0});function a(i){const r={};return i.integrity&&(r.integrity=i.integrity),i.referrerPolicy&&(r.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?r.credentials="include":i.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function s(i){if(i.ep)return;i.ep=!0;const r=a(i);fetch(i.href,r)}})();const z="https://your-energy.b.goit.study/api",D={mobile:9,tablet:12,desktop:12};y.defaults.baseURL=z;const J=(t,e,a)=>{const s={filter:t,page:e,limit:a};return y.get("/filters",{params:s})},K=t=>y.get(`/exercises/${t}`),W=t=>y.get("/exercises",{params:t}),Y=(t,e,a,s)=>{const i={rate:e,email:a,review:s};return y.patch(`/exercises/${t}/rating`,i)},h="/your-energy/assets/sprite-Bh03drsD.svg";function Z(t,e){const a="#EEA10C",s="#F4F4F4";let r="";for(let n=0;n<5;n++){const d=`starGradient${n}`,o=n+1<=t?100:n<t?t%1*100:0,c=[{offset:"0%",color:a,opacity:"1"},{offset:`${o}%`,color:a,opacity:"1"},{offset:`${o+1}%`,color:s,opacity:"0.20"}],l=`
    ...
    `,t}const I=()=>{const t=window.innerWidth;return t<768?"mobile":t<1440?"tablet":"desktop"},te=()=>D[I()];class E{constructor(){this.exercises=[],this.page=0,this.perPage=10,this.totalPages=0}addExercise(e){this.exercises.push(e)}static async fetchWithFilters(e){const s=(await W(e.toParams())).data,i=new E;return i.page=s.page,i.perPage=s.perPage,i.totalPages=s.totalPages,s.results.forEach(r=>{const n=new L(r._id,r.bodyPart,r.equipment,r.gifUrl,r.name,r.target,r.description,r.rating,r.burnedCalories,r.time,r.popularity);i.addExercise(n)}),i}render(e=!0,a=!1){const s=document.createElement("div");return s.className="exercise-list",this.exercises.forEach(i=>{s.appendChild(i.render(e,a))}),s}}const v=Object.freeze({MUSCLES:"muscles",BODY_PART:"bodypart",EQUIPMENT:"equipment"});class se{constructor({bodypart:e,muscles:a,equipment:s,keyword:i,page:r=1,limit:n=10}={}){this.bodypart=e,this.muscles=a,this.equipment=s,this.keyword=i,this.page=r,this.limit=n}addFilter(e,a){switch(e){case v.MUSCLES:this.muscles=a;break;case v.BODY_PART:this.bodypart=a;break;case v.EQUIPMENT:this.equipment=a;break}}addKeyword(e){this.keyword=e}toParams(){const e={};return this.bodypart&&(e.bodypart=this.bodypart),this.muscles&&(e.muscles=this.muscles),this.equipment&&(e.equipment=this.equipment),this.keyword&&(e.keyword=this.keyword),e.page=this.page,e.limit=this.limit,e}}const R=document.querySelector(".loader"),A=()=>{R.classList.remove("hidden")},j=()=>{R.classList.add("hidden")},p=document.querySelector(".exercise-container");let k=new E;const ae=async t=>{try{A(),k=await E.fetchWithFilters(t);const e=k.render(!0,!1);p.innerHTML="",p.appendChild(e)}catch(e){console.error(e)}finally{j()}};function O(t,e,a=null){const s=new se({page:1,limit:10});a&&s.addKeyword(a),s.addFilter(t,e),ae(s),p.classList.remove("hidden")}function ie(){p.innerHTML="",p.classList.contains("hidden")||p.classList.add("hidden")}const b=document.querySelector(".category-list"),F=document.querySelector(".category-container"),re=t=>t.reduce((e,a)=>e+`<li class="category-card" data-name="${a.name}" data-filter="${a.filter}">
