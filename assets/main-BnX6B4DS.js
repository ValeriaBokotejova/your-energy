import{a as v}from"./vendor-N5iQpiFS.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))t(r);new MutationObserver(r=>{for(const a of r)if(a.type==="childList")for(const c of a.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&t(c)}).observe(document,{childList:!0,subtree:!0});function s(r){const a={};return r.integrity&&(a.integrity=r.integrity),r.referrerPolicy&&(a.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?a.credentials="include":r.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function t(r){if(r.ep)return;r.ep=!0;const a=s(r);fetch(r.href,a)}})();const w="https://your-energy.b.goit.study/api",P={mobile:9,tablet:12,desktop:12};v.defaults.baseURL=w;const q=(i,e,s)=>{const t={filter:i,page:e,limit:s};return v.get("/filters",{params:t})},S=i=>v.get(`/exercises/${i}`),C=i=>v.get("/exercises",{params:i}),d="/your-energy/assets/sprite-gtohewle.svg";class p{constructor(e,s,t,r,a,c,h,n,o,l,u){this.id=e,this.bodyPart=s,this.equipment=t,this.gifUrl=r,this.name=a,this.target=c,this.description=h,this.rating=n,this.burnedCalories=o,this.time=l,this.popularity=u}setRatingVisible(e){this.ratingVisible=e}setTrashVisible(e){this.trashVisible=e}static async fetchById(e){const t=(await S(e)).data;return new p(t._id,t.bodyPart,t.equipment,t.gifUrl,t.name,t.target,t.description,t.rating,t.burnedCalories,t.time,t.popularity)}render(e=!0,s=!1){const t=document.createElement("div");return t.className="exercise-card",t.innerHTML=`  
    ...
    `,e}formatRating(){return this.rating.toFixed(1)}getStarRatingHTML(){let e="";const s='<svg width="18" height="18"><use href="${sprite}#star-active"></use></svg>',t='<svg width="18" height="18"><use href="${sprite}#star-inactive"></use></svg>';return e+=s.repeat(this.rating.toFixed(0)),e+=t.repeat(5-this.rating.toFixed(0)),e}}const b=document.querySelector(".modal-page");b&&p.fetchById("64f389465ae26083f39b17df").then(i=>{b.append(i.renderCard())});class f{constructor(){this.exercises=[],this.page=0,this.perPage=10,this.totalPages=0}addExercise(e){this.exercises.push(e)}static async fetchWithFilters(e){const t=(await C(e.toParams())).data,r=new f;return r.page=t.page,r.perPage=t.perPage,r.totalPages=t.totalPages,t.results.forEach(a=>{const c=new p(a._id,a.bodyPart,a.equipment,a.gifUrl,a.name,a.target,a.description,a.rating,a.burnedCalories,a.time,a.popularity);r.addExercise(c)}),r}render(e=!0,s=!1){const t=document.createElement("div");return t.className="exercise-list",this.exercises.forEach(r=>{t.appendChild(r.render(e,s))}),t}}const m=Object.freeze({MUSCLES:"muscles",BODY_PART:"bodypart",EQUIPMENT:"equipment"});class k{constructor({bodypart:e,muscles:s,equipment:t,keyword:r,page:a=1,limit:c=10}={}){this.bodypart=e,this.muscles=s,this.equipment=t,this.keyword=r,this.page=a,this.limit=c}addFilter(e,s){switch(e){case m.MUSCLES:this.muscles=s;break;case m.BODY_PART:this.bodypart=s;break;case m.EQUIPMENT:this.equipment=s;break}}toParams(){const e={};return this.bodypart&&(e.bodypart=this.bodypart),this.muscles&&(e.muscles=this.muscles),this.equipment&&(e.equipment=this.equipment),this.keyword&&(e.keyword=this.keyword),e.page=this.page,e.limit=this.limit,e}}const y=document.querySelector(".exercise-container");let E=new f;const T=async i=>{try{E=await f.fetchWithFilters(i);const e=E.render(!0,!1);y.innerHTML="",y.appendChild(e)}catch(e){console.error(e)}};function j(i,e){const s=new k({page:1,limit:10});s.addFilter(i,e),T(s),y.classList.remove("hidden")}const L=()=>{const i=window.innerWidth;return i<768?"mobile":i<1440?"tablet":"desktop"},A=()=>P[L()],g=document.querySelector(".category-list"),x=document.querySelector(".category-container"),M=i=>i.reduce((e,s)=>e+`<li class="category-card" data-name="${s.name}" data-filter="${s.filter}">
